...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/TulipaEnergy/TulipaClustering.jl
   ```
...
- After that runs, the [stable docs](https://TulipaEnergy.github.io/TulipaClustering.jl/stable) should be updated. Check them and look for the version number.
